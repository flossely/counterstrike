...
if (isset($meta['weapon'])) {
    gitPerform('https://github.com', 'thingy', 'main', 'flossely', $meta['weapon'].'.weapon.obj', $add, $meta['weapon'].'.weapon.obj');
}
if (isset($meta['melee'])) {
    gitPerform('https://github.com', 'thingy', 'main', 'flossely', $meta['melee'].'.melee.obj', $add, $meta['melee'].'.melee.obj');
}
if (isset($meta['shield'])) {
    gitPerform('https://github.com', 'thingy', 'main', 'flossely', $meta['shield'].'.shield.obj', $add, $meta['shield'].'.shield.obj');
}
